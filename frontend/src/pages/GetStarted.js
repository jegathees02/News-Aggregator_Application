                    ...
                    <div >
                        {articles.map(article => (
                            <div className="get-start-api-fetch-main" key={article.title}>
                                ...
                                <button className="get-start-api-fetch-button-two ml-6"><span className="get-start-api-fetch-button-two-span"><a href={article.url}>Read me</a></span></button>
                            </div>
                        ))}
                    </div>
                </div>
                <div className="get-start-right-side">
                    <div className="get-start-right-img-area fixed">
                        ...
                        <div className="get-start-button mt-3 mb-3">
                           <div><button className="get-start-nineteen"><span className="get-start-nineteen-span"><Link to="/login">Get Started!</Link></span></button></div>
                        </div>
                    </div>
                </div>
            </div>
